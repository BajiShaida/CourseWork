...
MainFile<-function(url,myfolder2,doc)
{
        ...
        while(option!=1 & option!=2)
        {
                ...
                option<-readline(prompt="Re-Enter Your Option:") 
        ...
        {       
                ...
                {
                        print("Enter The Option Correctly:")
                        option2<-readline(prompt="Re-Enter Your Option:") 
                        if(option2==1 | option2==2)
                                break
                }
                switch(option2,
                       "1"={
                               file12<-readline(prompt="Enter The File To be download:")
                       },
                       "2"={
                ...
                for(i in 1:h)
                {
                        for(j in 1:n)
                        {
                                ...
                                {
                                        print("enter The File Name Correctly")
                                }
                        }
                }
                if(k==0)
                {
                        print("there are No Files are Avaliable With That Name")
                }
        }
}
